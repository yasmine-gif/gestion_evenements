...
<div  class=" row justify-content-center "><h3>Administration****Modification*Evenements</h3></div>
</div>
<div class=" container center ml-2" >
   
       <div class="col-md-4 bg-light mt-4 box1 ml-2" > 
           <form action="../../administrateur/controleur/modification_evenement/controleur.formulaire.modifier.evenement.php" method="post" class="box ml-5">
              <h5> <p>Categorie</p></h5>
